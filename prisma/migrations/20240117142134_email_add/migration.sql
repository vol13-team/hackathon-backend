/*
  ...
  - Added the required column `select_option_id` to the `Answer` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "select_option_id" TEXT NOT NULL,
